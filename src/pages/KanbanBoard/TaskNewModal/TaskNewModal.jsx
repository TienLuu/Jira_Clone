         ...
         <DialogContent>
            <section className={cx("body")}>
               <MenuSelect
                  ...
                  renderItem={(item) => (
                     <div className={cx("taskType")}>
                        ...
                        <span>{taskTypeMap[item.id]?.name}</span>
                     </div>
                  )}
               ...
               <MenuSelect
                  ...
                  renderItem={(item) => (
                     <div className={cx("taskStatus")}>{item.statusName}</div>
                  )}
                  label="Status"
               ...
               <TextField
                  ...
                  ref={taskNameRef}
               />
               <MyCkEditor label="Description" editorRef={descriptionRef} />
            ...
            <footer className={cx("footer")}>
               <div className={cx("confirmBtnGroup")}>
                  <Button solid primary onClick={handleCreateTask}>
                     Create task
                  </Button>
                  <Button solid onClick={() => setIsOpen(false)}>
                     Cancle
                  </Button>
               </div>
            </footer>
