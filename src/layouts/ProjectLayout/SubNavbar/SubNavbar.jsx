            ...
            <div className={cx("content")}>
               <div className={cx("projectInfo")}>
                  ...
                  <div className={cx("projectName")}>
                     <h2>
                        {selectedProject?.projectName || "singularity 1.0"}
                     </h2>
                     <p>
               ...
               <div className={cx("navigation")}>
                  <ul className={cx("list")}>
                     <li className={cx("item")}>
                        <NavLink
                           to={`/jira/projects/${projectId}/kanban-board`}
                           className={({ isActive }) =>
                     ...
                     <li className={cx("item")}>
                        <NavLink
                           to={`/jira/projects/${projectId}/project-setting`}
                           className={({ isActive }) =>
                              cx("link", { active: isActive })
                           }
                           end
                  ...
                  <ul className={cx("list")}>
                     <li className={cx("item")}>
                        <NavLink
                           to={`/jira/projects/${projectId}/Releases`}
                           className={({ isActive }) =>
                              cx("link", { active: isActive })
                           }
                           end
                     ...
                     <li className={cx("item")}>
                        <NavLink
                           to={`/jira/projects/${projectId}/Issues`}
                           className={({ isActive }) =>
                              cx("link", { active: isActive })
                           }
                           end
                     ...
                     <li className={cx("item")}>
                        <NavLink
                           to={`/jira/projects/${projectId}/Pages`}
                           className={({ isActive }) =>
                              cx("link", { active: isActive })
                           }
                           end
                     ...
                     <li className={cx("item")}>
                        <NavLink
                           to={`/jira/projects/${projectId}/Reports`}
                           className={({ isActive }) =>
                              cx("link", { active: isActive })
                           }
                           end
                     ...
                     <li className={cx("item")}>
                        <NavLink
                           to={`/jira/projects/${projectId}/Components`}
                           className={({ isActive }) =>
                              cx("link", { active: isActive })
                           }
                           end
